...
class PaymentAvaibilityAdapter (context : Context, paymentList : ArrayList<HashMap<String,Any>>,
                                paymentAvaibilityListener : ApplicationListener.Companion.PaymentAvaibilityListener
) :
    RecyclerView.Adapter<PaymentAvaibilityAdapter.PaymentAvaibilityViewHolder>() {

    private val contexts = context
    private val paymentLists = paymentList
    private val listener = paymentAvaibilityListener
    ...
    override fun onBindViewHolder(holder: PaymentAvaibilityViewHolder, position: Int) {
        val paymentMap = paymentLists[position]
        ...
        holder.linearParent.setOnClickListener {
            ...
            isClicked = true
            listener.onPaymentAvaibilityClicked(paymentMap)
